<template>
  <div class="page actionsheet">
    <div class="page__header">
      <h1 class="header__title">ActionSheet</h1>
      <p class="header__desc">上拉单</p>
    </div>
...
<script>
import {Button, ActionSheet} from 'vweui'
export default {
  data () {
    return {
  ...
  methods: {
    ...
    handleActionClick: function (key) {
